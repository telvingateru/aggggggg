...
class ProductViewModel(var navController:NavHostController, var context: Context) {
    ...
    fun uploadProduct(carmodel: String,carbrand: String, price: String, enginesize: String, fueltype: String, transmission: String, mileage: String, filePath:Uri){
        ...
        storageRef.putFile(filePath).addOnCompleteListener{
            ...
            if (it.isSuccessful){
                ...
                storageRef.downloadUrl.addOnSuccessListener {
                    ...
                    var product = Product(carmodel,carbrand, enginesize, fueltype, transmission, mileage,price,imageUrl,productId)
