...
@Composable
fun CorollaScreen(navController: NavHostController) {
    Column (
        ...
        Row(
            ...
            Card {
                Image(
                    painter = painterResource(id = R.drawable.corolla2),
            ...
            Card {
                Image(
                    painter = painterResource(id = R.drawable.corolla3),
                    contentDescription = "evoque",
            ...
            Card {
                Image(
                    painter = painterResource(id = R.drawable.corolla4),
                    contentDescription = "evoque",
                    modifier = Modifier.size(width = 300.dp, height = 250.dp),
                    contentScale = ContentScale.Crop
                )
...
fun CorrolaScreenPreview(){
    MyCarStoreTheme {


        CorollaScreen(navController = rememberNavController())
    }
}
