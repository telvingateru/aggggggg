...
@Composable
fun Harrier1Screen(navController: NavHostController) {
    Column (
        ...
        Row(
            ...
            Card {
                Image(
                    painter = painterResource(id = R.drawable.harrier11),
            ...
            Card {
                Image(
                    painter = painterResource(id = R.drawable.harr2),
                    contentDescription = "evoque",
                    modifier = Modifier.size(width = 300.dp, height = 250.dp),
                    contentScale = ContentScale.Crop
                )
            ...
            Card {
                Image(
                    painter = painterResource(id = R.drawable.harr1),
                    contentDescription = "evoque",
                    modifier = Modifier.size(width = 300.dp, height = 250.dp),
                    contentScale = ContentScale.Crop
                )
...
fun Harrier1ScreenPreview(){
    MyCarStoreTheme {


        Harrier1Screen(navController = rememberNavController())
    }
}
