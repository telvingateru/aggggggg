...
@Composable
fun CrvScreen(navController: NavHostController) {
    Column (
        ...
        Row(
            ...
            Card {
                Image(
                    painter = painterResource(id = R.drawable.crv1),
                    contentDescription = "evoque",
            ...
            Card {
                Image(
                    painter = painterResource(id = R.drawable.crv2),
                    contentDescription = "evoque",
                    modifier = Modifier.size(width = 300.dp, height = 250.dp),
                    contentScale = ContentScale.Crop
                )
...
fun CrvScreenPreview(){
    MyCarStoreTheme {

        CrvScreen(navController = rememberNavController())
    }
}
