...
@Composable
fun Cx3Screen(navController: NavHostController) {
    Column (
        ...
        Row(
            ...
            Card {
                Image(
                    painter = painterResource(id = R.drawable.cx31),
                    contentDescription = "evoque",
            ...
            Card {
                Image(
                    painter = painterResource(id = R.drawable.cx32),
                    contentDescription = "evoque",
                    modifier = Modifier.size(width = 300.dp, height = 250.dp),
                    contentScale = ContentScale.Crop
                )
            ...
            Card {
                Image(
                    painter = painterResource(id = R.drawable.cx33),
                    contentDescription = "evoque",
                    modifier = Modifier.size(width = 300.dp, height = 250.dp),
                    contentScale = ContentScale.Crop
                )
...
fun Cx3ScreenPreview(){
    MyCarStoreTheme {


        Cx3Screen(navController = rememberNavController())
    }
}
