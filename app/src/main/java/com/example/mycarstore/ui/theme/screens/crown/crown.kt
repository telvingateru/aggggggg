...
@Composable
fun CrownScreen(navController: NavHostController) {
    Column (
        ...
        Row(
            ...
            Card {
                Image(
                    painter = painterResource(id = R.drawable.crown1),
            ...
            Card {
                Image(
                    painter = painterResource(id = R.drawable.crown2),
                    contentDescription = "evoque",
...
fun CrownScreenPreview(){
    MyCarStoreTheme {

        CrownScreen(navController = rememberNavController())
    }
}
