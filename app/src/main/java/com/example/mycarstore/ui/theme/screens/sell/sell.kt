package com.example.carstore.ui.theme.screens.sell
...
import com.example.mycarstore.ui.theme.screens.products.ImagePicker
...
fun ImagePicker(modifier: Modifier = Modifier, context: Context, navController: NavHostController, name:String, quantity:String, price:String) {
    ...
    fun SellScreenPreview(){
        SellScreen(navController = rememberNavController())
    }