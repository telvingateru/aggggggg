...
@Composable
fun Harrier2Screen(navController: NavHostController) {
    Column (
        ...
        Row(
            ...
            Card {
                Image(
                    painter = painterResource(id = R.drawable.harrier21),
                    contentDescription = "evoque",
            ...
            Card {
                Image(
                    painter = painterResource(id = R.drawable.harrier22),
                    contentDescription = "evoque",
                    modifier = Modifier.size(width = 300.dp, height = 250.dp),
                    contentScale = ContentScale.Crop
                )
...
fun Harrier2ScreenPreview(){
    MyCarStoreTheme {


        Harrier2Screen(navController = rememberNavController())
    }
}
