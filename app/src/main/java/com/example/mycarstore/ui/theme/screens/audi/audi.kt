...
@Composable
fun Audiq7Screen(navController: NavHostController) {
    Column (
        ...
        Row(
            ...
            Card {
                Image(
                    painter = painterResource(id = R.drawable.audiq7front),
                    contentDescription = "evoque",
            ...
            Card {
                Image(
                    painter = painterResource(id = R.drawable.q7interior),
                    contentDescription = "evoque",
                    modifier = Modifier.size(width = 300.dp, height = 250.dp),
                    contentScale = ContentScale.Crop
                )
            ...
            Card {
                Image(
                    painter = painterResource(id = R.drawable.audiq7view),
                    contentDescription = "evoque",
                    modifier = Modifier.size(width = 300.dp, height = 250.dp),
                    contentScale = ContentScale.Crop
                )
    ...
    fun Audiq7ScreenPreview(){
        MyCarStoreTheme {
            Audiq7Screen(navController = rememberNavController())
        }
    }
