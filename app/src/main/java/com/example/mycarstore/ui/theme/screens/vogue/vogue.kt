...
@Composable
fun VogueScreen(navController: NavHostController) {
    Column (
        ...
        Row(
            ...
            Card {
                Image(
                    painter = painterResource(id = R.drawable.vogue2),
                    contentDescription = "evoque",
            ...
            Card {
                Image(
                    painter = painterResource(id = R.drawable.vogue3),
                    contentDescription = "evoque",
                    modifier = Modifier.size(width = 300.dp, height = 250.dp),
                    contentScale = ContentScale.Crop
                )
...
fun VogueScreenPreview(){
    MyCarStoreTheme {


        VogueScreen(navController = rememberNavController())
    }
}
