...
@Composable
fun VitzScreen(navController: NavHostController) {
    Column (
        ...
        Row(
            ...
            Card {
                Image(
                    painter = painterResource(id = R.drawable.vitz),
            ...
            Card {
                Image(
                    painter = painterResource(id = R.drawable.vitz2),
                    contentDescription = "evoque",
            ...
            Card {
                Image(
                    painter = painterResource(id = R.drawable.vitz22),
                    contentDescription = "evoque",
                    modifier = Modifier.size(width = 300.dp, height = 250.dp),
                    contentScale = ContentScale.Crop
                )
...
fun VitzScreenPreview(){
    MyCarStoreTheme {


        VitzScreen(navController = rememberNavController())
    }
}
